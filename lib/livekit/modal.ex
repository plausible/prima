defmodule Livekit.Modal do
  ...
  `.modal`, `.modal_overlay`, and `.modal_panel`.
      ...
      <.button phx-click={Livekit.Modal.open("my-modal")}>
        Open Modal
      </.button>
  ...
  database queries before showing modal content.
      ...
      <.button phx-click={Livekit.Modal.open("async-modal") |> JS.push("load-data")}>
        Open Async Modal
      </.button>
  ...
  ## Example
      ...
      <.button phx-click={Livekit.Modal.close()}>
        Close
      </.button>

      # Chain with other JS commands
      <.button phx-click={Livekit.Modal.close() |> JS.push("modal-closed")}>
        Close and Notify
      </.button>
