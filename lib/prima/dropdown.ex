defmodule Prima.Dropdown do
  ...
  ## Examples
      ...
      # Basic trigger
      <.dropdown_trigger id="my-dropdown-trigger">
        Open Menu
      </.dropdown_trigger>

      # With custom component
      <.dropdown_trigger id="my-dropdown-trigger" as={&my_custom_button/1}>
        Open Menu
      </.dropdown_trigger>
  ...
  **IMPORTANT**: Custom components must accept and pass through global attributes
  ...
  ## Examples
      ...
      # Basic menu item
      <.dropdown_item id="save-item">
        Save
      </.dropdown_item>

      # Disabled menu item
      <.dropdown_item id="delete-item" disabled={true}>
        Delete (unavailable)
      </.dropdown_item>

      # With custom component (e.g., a link)
      <.dropdown_item id="profile-item" as={&my_link_component/1}>
        View Profile
      </.dropdown_item>

      # With Phoenix.Component.link
      <.dropdown_item id="profile-item" as={&link/1} navigate={~p"/profile"}>
        View Profile
      </.dropdown_item>
  ...
  **IMPORTANT**: Custom components must accept and pass through global attributes
  ...
  ## Examples
      ...
      <.dropdown_section>
        <.dropdown_heading id="recent-files-heading">Recent Files</.dropdown_heading>
        <.dropdown_item id="doc-item">Document.pdf</.dropdown_item>
        <.dropdown_item id="sheet-item">Spreadsheet.xlsx</.dropdown_item>
      </.dropdown_section>
  ...
  child of a section, the JavaScript hook sets the section's `aria-labelledby`
  to reference the heading's ID.
  """
